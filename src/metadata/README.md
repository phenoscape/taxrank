 ...
 * [taxrank.yml](taxrank.yml)
     * Determines how your purl.obolibrary.org/obo/taxrank/ redirects will be handled
     ...
     * Paste in the contents of [taxrank.yml](taxrank.yml)
 ...
 * [taxrank.md](taxrank.md)
     ...
     * Paste in the contents of [taxrank.md](taxrank.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
